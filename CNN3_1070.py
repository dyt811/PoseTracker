...
def load_data_and_run(model,input_shape, TBCallBack):
    ...
    train_data = train_data_loader.flow_from_directory(r"/home/dyt811/Git/MarkerTrainer/data_train",
    ...
    validation_data = validation_data_loader.flow_from_directory(r"/home/dyt811/Git/MarkerTrainer/data_validate",
                                                       target_size=(input_shape, input_shape),
                                                       batch_size=128,
                                                       color_mode="grayscale",
                                                       class_mode='binary')
    model_name = os.path.join(r"/home/dyt811/Git/MarkerTrainer/models", unique_name())
    ...
    model.save(os.path.join(r'/home/dyt811/Git/MarkerTrainer/models', unique_name()))
